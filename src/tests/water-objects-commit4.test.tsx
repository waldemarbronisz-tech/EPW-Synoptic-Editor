...
describe('the 6 new objects are registered (Water category - fix/wiring-and-library-groups commit 5 moved them out of TEREN) with the right states/terminals', () => {
