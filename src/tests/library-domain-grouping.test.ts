// fix/wiring-and-library-groups commit 5 - the 6 mandatory tests for
...
describe('21. TEREN contains exactly five entries', () => {
...
describe('22. the rainwater tank is in Water', () => {
  it('site.rainwater_tank2 (the MEASURED water-management tank) has category Water', () => {
...
describe('23. the alarm beacon is in Electrical', () => {
...
describe('24. the rain sensor is in Instrumentation', () => {
...
describe('25. every symbol belongs to EXACTLY one group', () => {
...
describe('26. the total number of visible symbols is unchanged from before the regroup', () => {
